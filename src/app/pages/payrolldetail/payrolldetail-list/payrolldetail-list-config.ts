...
import { PayrollDetail } from "src/app/response/payrolldetail/payrolldetail.response";
...
const searchOptions = [
    ...
    },
    {
        label: "conceptType",
        value: 1,
        placeholder: "Search conceptType",
...
const tableColumns: TableColumn<PayrollDetail>[] = [
    {
        label: "Id",
        property: "detailId",
        type: "identificador",
